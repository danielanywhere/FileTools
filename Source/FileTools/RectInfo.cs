...
namespace FileTools
{
	...
	//*-------------------------------------------------------------------------*
	/// <summary>
	/// Collection of RectInfoItem Items.
	/// </summary>
	public class RectInfoCollection : List<RectInfoItem>
	{
		//*************************************************************************
		//*	Private																																*
		//*************************************************************************
	...
	public class RectInfoItem
	{
		...
		/// </param>
		public static void Grow(RectInfoItem rectangle, float pixels)
		{
			float ax = 0f;
		...
		/// </param>
		public static void Square(RectInfoItem rectangle)
		{
			float maxDim = 0f;
