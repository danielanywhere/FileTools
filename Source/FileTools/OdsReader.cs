...
namespace LibreOfficeODS
{
	...
	public static class OdsReader
	{
			...
			XNamespace tableNs)
		{
			...
			IEnumerable<string> paragraphTexts = null;

			if(cellElement != null)
			{
				paragraphTexts = cellElement.Descendants()
			...
			//if(result.Contains("Open‑source CNC power you can build your way"))
			//{
			//	Trace.WriteLine("OdsReader.GetCellValue: Break here...");
			//}
			return result;
		}
		//*-----------------------------------------------------------------------*
